package es.udc.pa.pa006.cines.test.experiments;
...
import es.udc.pa.pa006.cines.model.userprofile.UserProfileDaoHibernate;
import es.udc.pa.pa006.cines.model.userservice.util.PasswordEncrypter;
...
public class DaoExperiments {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Register user.
			UserProfile userProfile = new UserProfile("daoUser", "88888888A",
